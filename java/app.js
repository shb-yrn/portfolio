...
const mobileNavLinks = document.querySelectorAll(
  "#mobile_nav li a , #aside_nav_link_btn",
);
...
const cer_infos = [
  ...
  },
  {
    ...
    url: "#",
    imgUrl: "images/certificate/scrum.webp",
  },
  {
    ...
    url: "#",
    imgUrl: "images/certificate/Gostar.webp",
    isContain: true,
  },
  {
    ...
    imgUrl: "images/certificate/Asp.Net_Core_Angular6.webp",
  },
  {
    ...
    imgUrl: "images/certificate/Asp.Net_Core.webp",
  },
  {
    title: "بوت کمپ مدیریت محصول",
    platform: "رهنماکالج",
    year: "1405",
    desc: "دوره فوق حرفه ای مدیریت محصول از رهنما کالج مدرسین این دوره جلیل علیزاده مدیر محصول دیجی پی و اوکالا و اسنپ هستند",
    url: "#",
    imgUrl: "",
  },
  {
...
const projectsData = [
  {
    ...
    tag: "صنعتی",
    challenge:
      "تیم بهره‌برداری ایستگاه تقویت فشار گاز برای پایش وضعیت توربین‌های زیمنس به بازدید حضوری و ثبت دستی پارامترها متکی بود؛ همین موضوع کنترل لحظه‌ای وضعیت تجهیزات را دشوار می‌کرد.",
    solution:
      "یک نرم‌افزار دسکتاپ تحت ویندوز با C# و DevExpress طراحی و پیاده‌سازی شد که پارامترهای عملکردی توربین‌ها را از دیتابیس SQL Server می‌خواند و در قالب داشبوردهای گرافیکی قابل‌فهم برای اپراتور نمایش می‌دهد.",
    result:
      "این نرم‌افزار در ایستگاه تقویت فشار گاز دهق اصفهان نصب و در حال استفاده است و پایش وضعیت توربین‌ها را برای اپراتورها ساده‌تر کرده است.",
  ...
  },
  {
    ...
    tag: "صنعتی",
    challenge:
      "مدیران ارشد نیاز داشتند وضعیت چند نیروگاه را به‌طور هم‌زمان و از یک نقطه واحد رصد کنند، بدون اینکه مجبور باشند بین چند سامانه جداگانه جابه‌جا شوند.",
    solution:
      "یک داشبورد تحت وب با بک‌اند .NET و SQL Server و فرانت‌اند HTML5، CSS3، JavaScript و Bootstrap ساخته شد که وضعیت هر واحد نیروگاهی را با نمودارهای Highcharts، AmCharts و Chart.js نمایش می‌دهد.",
    result:
      "این سامانه در نیروگاه شهید رجایی قزوین، نیروگاه کهنوج و نیروگاه کرمان مستقر شده و مدیریت متمرکز چند نیروگاه از یک پنل واحد را ممکن کرده است.",
  ...
  },
  {
    ...
    tag: "صنعتی",
    challenge:
      "ثبت دستی پارامترهای فشار و دما در ایستگاه‌های تقویت فشار گاز، احتمال خطای انسانی و تأخیر در گزارش‌گیری سازمانی را افزایش می‌داد.",
    solution:
      "سامانه‌ای تحت وب برای ثبت خودکار و گزارش‌گیری دوره‌ای پارامترهای ایستگاه‌ها با .NET و SQL Server در بک‌اند و HTML5، CSS3، JavaScript و Bootstrap در فرانت‌اند توسعه داده شد؛ داده‌ها با نمودارهای Highcharts و AmCharts نمایش داده می‌شوند.",
    result:
      "این سامانه در ایستگاه‌های تقویت فشار گاز سمنان، صفاشهر و پتاوه مستقر شده و دقت داده‌های ثبت‌شده را افزایش داده است.",
  ...
  },
  {
    ...
    tag: "سازمانی",
    challenge:
      "واحدهای مختلف سازمان داده‌های خود را در منابع پراکنده نگه می‌داشتند و تولید گزارش‌های مدیریتی یکپارچه زمان زیادی می‌برد.",
    solution:
      "موتور گزارش‌گیری پویا با .NET و SQL Server ساخته شد که داده‌های اکتسابی نیروگاه یا ایستگاه تقویت فشار گاز را در قالب نمودار نمایش می‌دهد و امکان چاپ مستقیم گزارش‌های تولیدشده را نیز فراهم می‌کند.",
    result:
      "زمان تهیه گزارش‌های مدیریتی به‌طور قابل‌توجهی کوتاه‌تر شد و دقت داده‌های ارائه‌شده به مدیران افزایش یافت.",
  ...
  },
  {
    ...
    tag: "سازمانی",
    challenge:
      "سازمان به سامانه‌ای یکپارچه برای مدیریت منابع انسانی، انبارداری، تسهیلات و رفاهی و خدمات پرسنلی نیاز داشت که جایگزین فرآیندهای پراکنده و دستی شود.",
    solution:
      "سامانه ERP با بک‌اند Django REST Framework و فرانت‌اند React.js طراحی و پیاده‌سازی شد؛ شامل ماژول‌های منابع انسانی، انبارداری، تسهیلات و رفاهی و خدمات.",
    result:
      "فرآیندهای پرسنلی و انبارداری سازمان یکپارچه و ساختاریافته شد و امکان مدیریت متمرکز ماژول‌های مختلف فراهم گردید.",
  ...
  },
  {
    ...
    tag: "آموزشی",
    challenge:
      "بسیاری از تیم‌های نرم‌افزاری Jira را نصب می‌کنند اما به دلیل عدم آشنایی با تنظیمات صحیح Workflow، از ظرفیت واقعی ابزار استفاده نمی‌کنند.",
    solution:
      "دوره‌ای کامل برای راه‌اندازی، پیکربندی Workflow، مدیریت پروژه و نصب پلاگین‌های کاربردی Jira طراحی و در پلتفرم مکتب‌خونه منتشر شد.",
    result:
      "صدها نفر از تیم‌های نرم‌افزاری توانستند Jira را به‌درستی در فرایند کاری خود پیاده‌سازی کنند.",
  ...
  },
  {
    ...
    tag: "بین‌المللی",
    challenge:
      "تیم‌های سازمانی که از Jira استفاده می‌کنند نیاز به قابلیت‌ها و افزونه‌های اختصاصی داشتند که در نسخه پایه Jira وجود نداشت.",
    solution:
      "به‌عنوان توسعه‌دهنده رسمی پلاگین Jira در شرکت Atlassian (استرالیا)، در طراحی و توسعه افزونه‌های Marketplace این پلتفرم مشارکت دارم.",
